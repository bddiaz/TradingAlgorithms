...
response = requests.get("https://finnhub.io/api/v1/stock/candle?",params = parameters)
...
newDict = {
    ...
    'macdHist': dictresponse2['macdHist'],
...
with open('indicatordatafile.csv','w') as newFile:
